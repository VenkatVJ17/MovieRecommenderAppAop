...
public class LoggingAspect {
    ...
    @AfterReturning(value = "execution(* com.venkatscode.movie.movie_recommender_aop.business.*.*(..))",
            returning = "result")
    ...
    @AfterThrowing(value = "execution(* com.venkatscode.movie.movie_recommender_aop.business.*.*(..))",
            throwing = "exception")
    ...
    @After(value = "execution(* com.venkatscode.movie.movie_recommender_aop.business.*.*(..))")
